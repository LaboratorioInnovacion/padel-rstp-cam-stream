@echo off
REM ===================================================================
REM Iniciar Setup Multi-Camara con Cloudflare Tunnel
REM Este archivo bypasea restricciones de PowerShell
REM ===================================================================

echo ========================================
echo  Setup Multi-Camara CLOUDFLARE
echo ========================================
echo.
...
if not exist "%PS_PATH%" (
    ...
    echo Por favor instala PowerShell o ejecuta directamente: setup-multicam-cloudflared.ps1
    pause
    exit /b 1
)

REM Ejecutar PowerShell con bypass de politica de ejecucion
"%PS_PATH%" -ExecutionPolicy Bypass -NoProfile -File "%~dp0setup-multicam-cloudflared.ps1"
